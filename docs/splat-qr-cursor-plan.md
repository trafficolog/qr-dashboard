...
> **Цель:** Детализированный план продолжения разработки (Эпики **5–14**) для автономной реализации AI-агентом в Cursor IDE. Эпики **15–21** сведены в таблицу ниже; детальные спецификации — в отдельных `docs/epic-*.md`.
...
| # | Эпик | Фаза | Статус | Оценка / релиз | Зависимости |
|---|------|------|--------|------------------|-------------|
| 5 | Redirect и сбор аналитики | 1 (MVP) | ✅ Завершён (v0.3.0) | 2–3 дня | Эпики 1, 4 |
| 6 | Аналитика (базовая) | 1 (MVP) | ✅ Завершён (v0.4.0) | 3–4 дня | Эпики 1, 4, 5 |
| 7 | Папки и теги | 2 | ✅ Завершён (v0.5.0) | 2–3 дня | Эпики 1, 4 |
| 8 | Расширенная кастомизация QR | 2 | ⏳ Ожидает | 3–4 дня | Эпик 4 |
| 9 | A/B-тестирование | 3 | ✅ Завершён (v0.6.0) | 2 дня | Эпики 4, 5 |
| 10 | Массовое создание CSV | 3 | ✅ Завершён (v0.7.0) | 2–3 дня | Эпик 4 |
| 11 | Управление командой | 3 | ✅ Завершён (v0.8.0) | 2 дня | Эпик 2 |
| 12 | API v1 и ключи | 4 | ✅ Завершён (v0.9.0) | 2 дня | Эпики 2, 4 |
...
Сессия 9: Эпик 15 (Forms UX) — v0.12.0
           → guard черновиков, единая валидация, 422 на полях

Сессия 10: Эпик 16 (Interactive Shell) — по готовности
           → поиск, настройки, интерактив shell — см. epic-16-interactive-shell.md
...
- [ ] **EPIC 21 — фаза 0** (блокеры из [epic-21-security-hardening.md](./epic-21-security-hardening.md)) выполнены перед production
