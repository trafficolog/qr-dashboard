...
После завершения Фазы 0 проект может быть развёрнут в production (в т.ч. на промежуточной 0.x-версии). **Релиз 1.0.0** планируется после завершения EPIC 21 целиком (все фазы или согласованный срез объёма) — см. [planned-epics-15-18.md](./planned-epics-15-18.md).
