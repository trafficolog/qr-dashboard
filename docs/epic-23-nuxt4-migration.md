...
**Статус:** ✅ Done (закрыт после полного выполнения acceptance-критериев, решение от 2026-04-21)
**Целевая версия:** v0.15.0 (final for EPIC 23; `1.0.0` вне скоупа этого эпика)
**Дата завершения:** 2026-04-21
**Итоговый review:** [docs/reviews/epic-23-final-review.md](./reviews/epic-23-final-review.md)
**Сверка версии:** `package.json` = `0.13.0`; последний оформленный релиз в `CHANGELOG.md` = `0.12.1`; релизный контур EPIC 23 зафиксирован как `0.15.0` в release-prep секции changelog.
...
**Критерии приёмки:**
- [x] Все 18 задач эпика отмечены выполненными
- [x] Версия в `package.json` сверена (`0.13.0`) и зафиксирована как текущая в репозитории
- [x] `CHANGELOG.md` сверен: последний оформленный релиз `[0.12.1]`, release-prep EPIC 23 отражён в `Unreleased`
- [x] `docs/reviews/epic-23-final-review.md` опубликован
- [x] `README.md` обновлён
- [x] PR прошёл CI (lint, typecheck, tests)
