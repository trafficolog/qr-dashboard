...
>
> Статусы эпиков ведутся централизованно в [EPIC Status Matrix](./epic-status-matrix.md). При закрытии EPIC сначала обновляется матрица, затем README/CHANGELOG.
...
## Эпик 23 — Миграция на Nuxt 4 и обновление ключевых модулей (Завершён 2026-04-21)

### Результат
- Обновлён основной стек до Nuxt 4 + Nuxt UI 4 + Pinia 3 + Drizzle 0.45.x + i18n v10.
- Финализированы задачи 23.1–23.18 в итоговом review и подтверждена релизная версия `0.15.0`.
- Подтверждена готовность к rollout: staging — ready, production — ready with follow-ups.

### Финальная фиксация
- Финальный review: `docs/reviews/epic-23-final-review.md`
- Чеклист smoke: `docs/reviews/epic-23-smoke-checklist.md`
- Остаточные задачи после релиза: `NEXT-23-01..NEXT-23-07` (owner/deadline назначены)
