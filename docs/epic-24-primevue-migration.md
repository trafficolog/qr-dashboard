...
- ⚠️ Settings migration in progress: `/settings` shell navigation, `/settings/general`, `/settings/profile` и `/settings/team` переведены на PrimeVue InputText/Select/Icon/Tag/Dialog/Message patterns
