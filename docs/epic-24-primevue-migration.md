...
- ⚠️ Settings migration in progress: `/settings` shell navigation, `/settings/general` и `/settings/profile` переведены на PrimeVue InputText/Select/Icon/Tag patterns
