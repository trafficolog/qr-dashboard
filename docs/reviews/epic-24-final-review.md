...
## 6. Выявленные риски и follow-up
...
### 6.2. Остаточные риски / follow-up
...
### 7.3. Функциональность (EPIC 1–22 сохранена)
