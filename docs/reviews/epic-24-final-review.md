...
| 24.36 | A11y sweep | ⚠️ | PR7 | `follow-up commits (public scan a11y + keyboard stabilization)` | Public A11y покрытие усилено: `/not-found` и `/expired` проходят axe (light/dark), keyboard smoke для auth/scan страниц стабилизирован; финальный full-green всё ещё зависит от unskip приватного E2E-контура (см. 24.35). |
