...
CREATE TYPE "public"."qr_visibility" AS ENUM('private', 'department', 'public');
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "qr_codes" ADD COLUMN "visibility" "qr_visibility" DEFAULT 'private' NOT NULL;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "departments_head_user_idx" ON "departments" USING btree ("head_user_id");
--> statement-breakpoint
CREATE INDEX "user_departments_department_idx" ON "user_departments" USING btree ("department_id");
--> statement-breakpoint
CREATE INDEX "user_departments_user_idx" ON "user_departments" USING btree ("user_id");
--> statement-breakpoint
CREATE INDEX "qr_visibility_idx" ON "qr_codes" USING btree ("visibility");
--> statement-breakpoint
